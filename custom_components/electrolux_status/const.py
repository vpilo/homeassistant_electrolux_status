...
Catalog: dict[str, [dict, str, str, str, str]] = {
        ...
        "targetMicrowavePower": [{"access": "read","type": "number"}, None, SensorDeviceClass.ENERGY, UnitOfPower.WATT, "mdi:microwave"],
        "ovenProcessIdentifier": [{"access": "read","type": "string"}, None, None, None, None],
        "remoteControl": [{"access": "read","type": "string"}, None, None, None, "mdi:remote"],
        ...
        "startTime": [{"access": "readwrite","type": "number","max": 72000,"min": 0,"step": 1800}, None, None, UnitOfTime.SECONDS, "mdi:clock-start"],
        ...
        "applianceTotalWorkingTime": [{"access": "read", "type": "number"}, None, None, UnitOfTime.MINUTES, EntityCategory.DIAGNOSTIC, "mdi:clock-time-eight-outline"],
