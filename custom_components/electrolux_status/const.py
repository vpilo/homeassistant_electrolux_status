...
# TIME_ENTITIES_TO_UPDATE = ["timeToEnd"]  # Not currently in use
...
Catalog: dict[str, ElectroluxDevice] = {
    "analogSpinSpeed": ElectroluxDevice(
        capability_info={
            "access": "readwrite",
            "type": "string",
            "values": {
    ...
    "analogTemperature": ElectroluxDevice(
        capability_info={
            "access": "readwrite",
            "type": "string",
            "values": {
